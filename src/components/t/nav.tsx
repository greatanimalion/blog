...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="absolute top-[1em] z-1000 w-full! left-0 md:w-auto md:left-auto text-center">
      <nav
        className={`w-full md:w-max m-auto flex items-center justify-between md:justify-start box-border px-4 md:px-0 ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
